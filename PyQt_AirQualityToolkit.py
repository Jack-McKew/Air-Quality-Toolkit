...
from modules.DialogBoxes import ErrorBox
from modules.CSVFormatter import *
from modules.Stitcher import *
from modules.Factorizer import *
from modules.NO2Processor import *
from modules.Statistics_Generator import *
from modules.Contemporaneous import *
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Stat_Browse_1 = QtWidgets.QPushButton(self.groupBox1)
        self.Stat_Browse_1.setObjectName("Stat_Browse_1")
        self.gridLayout.addWidget(self.Stat_Browse_1, 0, 2, 1, 1)
        self.Stat_Run_1 = QtWidgets.QPushButton(self.groupBox1)
        ...
        self.Stat_Max = QtWidgets.QCheckBox(self.groupBox2)
        self.Stat_Max.setChecked(True)
        self.Stat_Max.setObjectName("Stat_Max")
        self.gridLayout_2.addWidget(self.Stat_Max, 1, 0, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.Stat_Average = QtWidgets.QCheckBox(self.groupBox2)
        self.Stat_Average.setChecked(True)
        self.Stat_Average.setObjectName("Stat_Average")
        self.gridLayout_2.addWidget(
            self.Stat_Average, 0, 0, 1, 1, QtCore.Qt.AlignHCenter
        )
        self.Stat_Max_Average = QtWidgets.QCheckBox(self.groupBox2)
        ...
        self.gridLayout_2.addWidget(
            self.Stat_Max_Average, 0, 1, 1, 1, QtCore.Qt.AlignHCenter
        )
        ...
        self.Stat_Max_Max = QtWidgets.QCheckBox(self.groupBox2)
        self.Stat_Max_Max.setChecked(True)
        self.Stat_Max_Max.setObjectName("Stat_Max_Max")
        self.gridLayout_2.addWidget(
            self.Stat_Max_Max, 1, 1, 1, 1, QtCore.Qt.AlignHCenter
        )
        self.gridLayout_7 = QtWidgets.QGridLayout()
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.Stat_Percentile_En = QtWidgets.QCheckBox(self.groupBox2)
        self.Stat_Percentile_En.setObjectName("Stat_Percentile_En")
        self.gridLayout_7.addWidget(
            self.Stat_Percentile_En, 0, 0, 1, 1, QtCore.Qt.AlignHCenter
        )
        self.Stat_Percentile_Max = QtWidgets.QCheckBox(self.groupBox2)
        self.Stat_Percentile_Max.setObjectName("Stat_Percentile_Max")
        self.gridLayout_7.addWidget(
            self.Stat_Percentile_Max, 1, 0, 1, 1, QtCore.Qt.AlignHCenter
        )
        self.gridLayout_2.addLayout(self.gridLayout_7, 2, 2, 1, 1)
        self.gridLayout_8 = QtWidgets.QGridLayout()
        self.gridLayout_8.setObjectName("gridLayout_8")
        self.Stat_Rolling_En = QtWidgets.QCheckBox(self.groupBox2)
        self.Stat_Rolling_En.setObjectName("Stat_Rolling_En")
        self.gridLayout_8.addWidget(
            self.Stat_Rolling_En, 0, 0, 1, 1, QtCore.Qt.AlignHCenter
        )
        self.Stat_Rolling_Max = QtWidgets.QCheckBox(self.groupBox2)
        self.Stat_Rolling_Max.setObjectName("Stat_Rolling_Max")
        self.gridLayout_8.addWidget(
            self.Stat_Rolling_Max, 1, 0, 1, 1, QtCore.Qt.AlignHCenter
        )
        self.gridLayout_2.addLayout(self.gridLayout_8, 3, 2, 1, 1)
        self.Stat_Percentile_Num = QtWidgets.QLineEdit(self.groupBox2)
        self.Stat_Percentile_Num.setObjectName("Stat_Percentile_Num")
        self.gridLayout_2.addWidget(self.Stat_Percentile_Num, 2, 1, 1, 1)
        self.Stat_Rolling_Num = QtWidgets.QLineEdit(self.groupBox2)
        self.Stat_Rolling_Num.setObjectName("Stat_Rolling_Num")
        self.gridLayout_2.addWidget(self.Stat_Rolling_Num, 3, 1, 1, 1)
        ...
        self.gridLayout_10 = QtWidgets.QGridLayout(self.gridGroupBox)
        self.gridLayout_10.setContentsMargins(25, -1, 25, -1)
        self.gridLayout_10.setHorizontalSpacing(100)
        self.gridLayout_10.setVerticalSpacing(0)
        self.gridLayout_10.setObjectName("gridLayout_10")
        self.Stat_Con_Back_Browse = QtWidgets.QPushButton(self.gridGroupBox)
        self.Stat_Con_Back_Browse.setObjectName("Stat_Con_Back_Browse")
        self.gridLayout_10.addWidget(self.Stat_Con_Back_Browse, 1, 2, 1, 1)
        self.Stat_Con_Input_Browse = QtWidgets.QPushButton(self.gridGroupBox)
        self.Stat_Con_Input_Browse.setObjectName("Stat_Con_Input_Browse")
        self.gridLayout_10.addWidget(self.Stat_Con_Input_Browse, 0, 2, 1, 1)
        self.Stat_Con_Input_Name = QtWidgets.QLineEdit(self.gridGroupBox)
        self.Stat_Con_Input_Name.setObjectName("Stat_Con_Input_Name")
        self.gridLayout_10.addWidget(self.Stat_Con_Input_Name, 0, 1, 1, 1)
        self.label_4 = QtWidgets.QLabel(self.gridGroupBox)
        self.label_4.setObjectName("label_4")
        self.gridLayout_10.addWidget(self.label_4, 0, 0, 1, 1, QtCore.Qt.AlignHCenter)
        self.Stat_Con_Criteria = QtWidgets.QLineEdit(self.gridGroupBox)
        self.Stat_Con_Criteria.setObjectName("Stat_Con_Criteria")
        self.gridLayout_10.addWidget(self.Stat_Con_Criteria, 3, 1, 1, 1)
        self.label_9 = QtWidgets.QLabel(self.gridGroupBox)
        self.label_9.setObjectName("label_9")
        self.gridLayout_10.addWidget(self.label_9, 1, 0, 1, 1, QtCore.Qt.AlignHCenter)
        self.Stat_Con_Back_Name = QtWidgets.QLineEdit(self.gridGroupBox)
        self.Stat_Con_Back_Name.setObjectName("Stat_Con_Back_Name")
        self.gridLayout_10.addWidget(self.Stat_Con_Back_Name, 1, 1, 1, 1)
        self.label_10 = QtWidgets.QLabel(self.gridGroupBox)
        self.label_10.setObjectName("label_10")
        self.gridLayout_10.addWidget(self.label_10, 3, 0, 1, 1, QtCore.Qt.AlignHCenter)
        self.label_11 = QtWidgets.QLabel(self.gridGroupBox)
        self.label_11.setObjectName("label_11")
        self.gridLayout_10.addWidget(self.label_11, 4, 0, 1, 1, QtCore.Qt.AlignHCenter)
        self.Stat_Con_Out_Name = QtWidgets.QLineEdit(self.gridGroupBox)
        self.Stat_Con_Out_Name.setObjectName("Stat_Con_Out_Name")
        self.gridLayout_10.addWidget(self.Stat_Con_Out_Name, 4, 1, 1, 1)
        self.Stat_Con_Run = QtWidgets.QPushButton(self.gridGroupBox)
        self.Stat_Con_Run.setObjectName("Stat_Con_Run")
        self.gridLayout_10.addWidget(self.Stat_Con_Run, 4, 2, 1, 1)
        self.label_12 = QtWidgets.QLabel(self.gridGroupBox)
        self.label_12.setObjectName("label_12")
        self.gridLayout_10.addWidget(self.label_12, 2, 0, 1, 1, QtCore.Qt.AlignHCenter)
        self.Stat_Con_Header_Num = QtWidgets.QLineEdit(self.gridGroupBox)
        self.Stat_Con_Header_Num.setObjectName("Stat_Con_Header_Num")
        self.gridLayout_10.addWidget(self.Stat_Con_Header_Num, 2, 1, 1, 1)
        self.gridLayout_9.addWidget(self.gridGroupBox, 2, 0, 1, 1)
        ...
        self.gridLayout_27.addItem(spacerItem, 1, 0, 1, 1)
        ...
        self.gridLayout_26.addWidget(
            self.NO2_Calpuff_Format, 2, 0, 1, 1, QtCore.Qt.AlignHCenter
        )
        ...
        self.gridLayout_23.addWidget(
            self.label_21, 1, 0, 1, 1, QtCore.Qt.AlignHCenter | QtCore.Qt.AlignVCenter
        )
        ...
        MainWindow.setTabOrder(self.NO2_Run_Stats, self.Stat_To_Convert)
        MainWindow.setTabOrder(self.Stat_To_Convert, self.Stat_Browse_1)
        MainWindow.setTabOrder(self.Stat_Browse_1, self.Stat_Header)
        MainWindow.setTabOrder(self.Stat_Header, self.Stat_Output)
        MainWindow.setTabOrder(self.Stat_Output, self.Stat_Run_1)
        MainWindow.setTabOrder(self.Stat_Run_1, self.Stat_Average)
        MainWindow.setTabOrder(self.Stat_Average, self.Stat_Max_Average)
        MainWindow.setTabOrder(self.Stat_Max_Average, self.Stat_Max)
        MainWindow.setTabOrder(self.Stat_Max, self.Stat_Max_Max)
        MainWindow.setTabOrder(self.Stat_Max_Max, self.Stat_Percentile_Num)
        MainWindow.setTabOrder(self.Stat_Percentile_Num, self.Stat_Percentile_En)
        MainWindow.setTabOrder(self.Stat_Percentile_En, self.Stat_Percentile_Max)
        MainWindow.setTabOrder(self.Stat_Percentile_Max, self.Stat_Rolling_Num)
        MainWindow.setTabOrder(self.Stat_Rolling_Num, self.Stat_Rolling_En)
        MainWindow.setTabOrder(self.Stat_Rolling_En, self.Stat_Rolling_Max)
        MainWindow.setTabOrder(self.Stat_Rolling_Max, self.Stat_Con_Input_Name)
        MainWindow.setTabOrder(self.Stat_Con_Input_Name, self.Stat_Con_Input_Browse)
        MainWindow.setTabOrder(self.Stat_Con_Input_Browse, self.Stat_Con_Back_Name)
        MainWindow.setTabOrder(self.Stat_Con_Back_Name, self.Stat_Con_Back_Browse)
        MainWindow.setTabOrder(self.Stat_Con_Back_Browse, self.Stat_Con_Header_Num)
        MainWindow.setTabOrder(self.Stat_Con_Header_Num, self.Stat_Con_Criteria)
        MainWindow.setTabOrder(self.Stat_Con_Criteria, self.Stat_Con_Out_Name)
        MainWindow.setTabOrder(self.Stat_Con_Out_Name, self.Stat_Con_Run)
        MainWindow.setTabOrder(self.Stat_Con_Run, self.Stitcher_Import)
        MainWindow.setTabOrder(self.Stitcher_Import, self.Stitcher_Out_Folder)
        MainWindow.setTabOrder(self.Stitcher_Out_Folder, self.Stitcher_Clear)
        MainWindow.setTabOrder(self.Stitcher_Clear, self.Stitcher_Run)
        MainWindow.setTabOrder(self.Stitcher_Run, self.Stitcher_Browse)
        MainWindow.setTabOrder(self.Stitcher_Browse, self.Stitcher_Table)
        MainWindow.setTabOrder(self.Stitcher_Table, self.Factorizer_Table)
        MainWindow.setTabOrder(self.Factorizer_Table, self.Factorizer_Import)
        MainWindow.setTabOrder(self.Factorizer_Import, self.Factorizer_Clear)
        MainWindow.setTabOrder(self.Factorizer_Clear, self.Factorizer_Run)
        MainWindow.setTabOrder(self.Factorizer_Run, self.Factorizer_Browse_Input)
        MainWindow.setTabOrder(
            self.Factorizer_Browse_Input, self.Factorizer_Browse_Factor
        )
        MainWindow.setTabOrder(self.Factorizer_Browse_Factor, self.MassCSV_Table)
        MainWindow.setTabOrder(self.MassCSV_Table, self.MassCSV_Browse)
        MainWindow.setTabOrder(self.MassCSV_Browse, self.MassCSV_Run)
        MainWindow.setTabOrder(self.MassCSV_Run, self.MassCSV_Import)
        MainWindow.setTabOrder(self.MassCSV_Import, self.MassCSV_Clear)
        MainWindow.setTabOrder(self.MassCSV_Clear, self.Stitcher_Out_File)
        MainWindow.setTabOrder(self.Stitcher_Out_File, self.tabWidget)
        MainWindow.setTabOrder(self.tabWidget, self.NO2_File_To_Format)
        MainWindow.setTabOrder(self.NO2_File_To_Format, self.NO2_Browse_Format_CSV)
        MainWindow.setTabOrder(self.NO2_Browse_Format_CSV, self.NO2_Output_Format)
        MainWindow.setTabOrder(self.NO2_Output_Format, self.NO2_Convert_To_CSV)
        MainWindow.setTabOrder(self.NO2_Convert_To_CSV, self.NO2_Calpuff_Format)
        MainWindow.setTabOrder(self.NO2_Calpuff_Format, self.NO2_Process_CSV)
        MainWindow.setTabOrder(self.NO2_Process_CSV, self.NO2_Process_CSV_Browse)
        MainWindow.setTabOrder(self.NO2_Process_CSV_Browse, self.NO2_Background_File)
        MainWindow.setTabOrder(self.NO2_Background_File, self.NO2_Background_Browse)
        MainWindow.setTabOrder(self.NO2_Background_Browse, self.NO2_Initial_Percent)
        MainWindow.setTabOrder(self.NO2_Initial_Percent, self.NO2_Exceedances)
        MainWindow.setTabOrder(self.NO2_Exceedances, self.NO2_Header_Columns)
        MainWindow.setTabOrder(self.NO2_Header_Columns, self.NO2_Output_Statistics)
    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(
            _translate("MainWindow", "Air Quality Toolkit - 30/11/18")
        )
        self.groupBox.setTitle(_translate("MainWindow", "Statistics Tools"))
        self.groupBox1.setTitle(_translate("MainWindow", "File Settings"))
        self.label.setText(_translate("MainWindow", "Filename of CSV to process:"))
        self.label_2.setText(
            _translate("MainWindow", "Number of header columns in dataset (eg 3):")
        )
        self.Stat_Browse_1.setText(_translate("MainWindow", "Browse"))
        self.Stat_Run_1.setText(_translate("MainWindow", "Run"))
        self.label_3.setText(
            _translate("MainWindow", "File name of output statistics CSV:")
        )
        self.groupBox2.setTitle(_translate("MainWindow", "Statistics Settings"))
        self.Stat_Max.setText(_translate("MainWindow", "Max of Sensor"))
        self.label_5.setText(
            _translate("MainWindow", "Percentile to compute (eg 99.9)")
        )
        self.Stat_Average.setText(_translate("MainWindow", "Average of Sensor"))
        self.Stat_Max_Average.setText(
            _translate("MainWindow", "Max Average of Sensors")
        )
        ...
        self.gridGroupBox.setTitle(
            _translate("MainWindow", "Contemporaneous Processing")
        )
        self.Stat_Con_Back_Browse.setText(_translate("MainWindow", "Browse"))
        self.Stat_Con_Input_Browse.setText(_translate("MainWindow", "Browse"))
        self.label_4.setText(_translate("MainWindow", "File of input data"))
        self.Stat_Con_Criteria.setText(_translate("MainWindow", "5"))
        self.label_9.setText(_translate("MainWindow", "File of background pollutant"))
        self.label_10.setText(
            _translate("MainWindow", "Number of rows to output (eg 5)")
        )
        self.label_11.setText(_translate("MainWindow", "File name of output results"))
        self.Stat_Con_Run.setText(_translate("MainWindow", "Run"))
        self.label_12.setText(
            _translate("MainWindow", "Number of header columns in datasets (eg 3)")
        )
        self.Stat_Con_Header_Num.setText(_translate("MainWindow", "3"))
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tab),
            _translate("MainWindow", "Statistics Generator"),
        )
        ...
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Stitcher")
        )
        ...
        self.Factorizer_Browse_Input.setText(
            _translate("MainWindow", "Browse Input File")
        )
        self.Factorizer_Browse_Factor.setText(
            _translate("MainWindow", "Browse Factor File")
        )
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tab_3), _translate("MainWindow", "Factorizer")
        )
        ...
        self.tabWidget.setTabText(
            ...
            _translate("MainWindow", "Mass CSV Formatter"),
        )
        ...
        self.NO2_Calpuff_Format.setText(
            _translate("MainWindow", "CALPUFF Output Format?")
        )
        ...
        self.label_21.setText(
            _translate("MainWindow", "File name of Background NO2 CSV:")
        )
        self.label_23.setText(
            _translate("MainWindow", "Number of exceedances limit (eg 246)")
        )
        ...
        self.tabWidget.setTabText(
            ...
            _translate("MainWindow", "NO2 Processor"),
        )
        ...
        self.Stat_Con_Input_Browse.clicked.connect(self.Stat_Con_In_Clicked)
        self.Stat_Con_Back_Browse.clicked.connect(self.Stat_Con_Back_Clicked)
        self.Stat_Con_Run.clicked.connect(self.Stat_Con_Run_Clicked)
        ...
        # FACTORIZER BUTTONS
        self.Factorizer_Browse_Input.clicked.connect(
            self.Factorizer_Browse_Input_Clicked
        )
        self.Factorizer_Browse_Factor.clicked.connect(
            self.Factorizer_Browse_Factor_Clicked
        )
    ...
    def Stat_Run_Clicked(self):
        ...
        try:
            Statistics_Generator(
                settings,
                self.Stat_Header.text(),
                self.Stat_To_Convert.text(),
                self.Stat_Output.text(),
            )
            ...
            err = traceback.format_exc()
            ErrorBox("Error", "An error has occured", err)
    def Stat_Con_In_Clicked(self):
        try:
            self.Stat_Con_Input_Name.setText("")
            options = QFileDialog.Options()
            # options |= QFileDialog.DontUseNativeDialog
            filename, _ = QFileDialog.getOpenFileNames(
                None,
            ...
            self.Stat_Con_Input_Name.setText(filename[0])
            self.Stat_Con_Out_Name.setText(filename[0].split(".")[0] + "_Con.csv")
        except IndexError as err:
            err = traceback.format_exc()
            ErrorBox("No File Selected", "Please select a file", err)
        except Exception as err:
            err = traceback.format_exc()
            ErrorBox("Error", "An error has occured", err)
    def Stat_Con_Back_Clicked(self):
        try:
            self.Stat_Con_Back_Name.setText("")
            options = QFileDialog.Options()
            # options |= QFileDialog.DontUseNativeDialog
            filename, _ = QFileDialog.getOpenFileNames(
                None,
            ...
            self.Stat_Con_Back_Name.setText(filename[0])
        except IndexError as err:
            err = traceback.format_exc()
            ErrorBox("No File Selected", "Please select a file", err)
        except Exception as err:
            err = traceback.format_exc()
            ErrorBox("Error", "An error has occured", err)
    def Stat_Con_Run_Clicked(self):
        contemporaneous(
            self.Stat_Con_Header_Num.text(),
            self.Stat_Con_Input_Name.text(),
            self.Stat_Con_Back_Name.text(),
            self.Stat_Con_Criteria.text(),
            self.Stat_Con_Out_Name.text(),
        )
    #### STITCHER FUNCTIONS
    def Stitcher_Browse_Clicked(self):
        try:
            ...
            for row in range(self.Stitcher_Table.rowCount()):
                if (
                    self.Stitcher_Table.item(row, 0) == None
                    and row == self.Stitcher_Table.rowCount() - 1
                ):
                    self.Stitcher_Table.insertRow(row)
                if self.Stitcher_Table.item(row, 0) == None:
                    self.Stitcher_Table.setItem(
                        row, 0, QTableWidgetItem(os.path.split(filename[0])[0])
                    )
                    self.Stitcher_Table.setItem(
                        row, 1, QTableWidgetItem(os.path.split(filename[0])[1])
                    )
                    if row == 0:
    ...
    def Stitcher_Import_Clicked(self):
        try:
            ...
            for folder, filename, scale, header, row in zip(
                settings.loc[:, "Folder"],
                settings.loc[:, "Filename"],
                settings.loc[:, "Scale"],
                settings.loc[:, "Headers"],
                range(len(settings.loc[:, "Folder"])),
            ):
                if (
                    self.Stitcher_Table.item(row, 0) == None
                    and row == self.Stitcher_Table.rowCount() - 1
    ...
    def Stitcher_Run_Clicked(self):
        ...
        try:
            ...
            ErrorBox(
                "Invalid Settings",
                "Invalid settings, please review input table for errors",
                err,
            )
        except Exception as err:
            ErrorBox("Error", "An error has occured", err)
        try:
            Stitcher(
                ...
                headers,
                os.path.join(
                    self.Stitcher_Out_Folder.text(), self.Stitcher_Out_File.text()
                ),
            )
            ...
            ErrorBox(
                "Incorrect Settings",
                "Incorrect settings, please review input table for errors",
                error,
            )
        except Exception as err:
            err = traceback.format_exc()
    ...
    def Factorizer_Browse_Input_Clicked(self):
        try:
            ...
            for row in range(self.Factorizer_Table.rowCount()):
                if (
                    self.Factorizer_Table.item(row, 0) == None
                    and row == self.Factorizer_Table.rowCount() - 1
                ):
                ...
                if self.Factorizer_Table.item(row, 0) == None:
                    ...
                    self.Factorizer_Table.setItem(
                        row,
                        2,
                        QTableWidgetItem(filename[0].split(".")[0] + "_Factorized.csv"),
                    )
                    break
        except IndexError as err:
            err = traceback.format_exc()
    ...
    def Factorizer_Browse_Factor_Clicked(self):
        try:
            ...
            for row in range(self.Factorizer_Table.rowCount()):
                if (
                    self.Factorizer_Table.item(row, 1) == None
                    and row == self.Factorizer_Table.rowCount() - 1
                ):
                    self.Factorizer_Table.insertRow(row)
    ...
    def Factorizer_Import_Clicked(self):
        try:
            ...
            settings = pd.read_csv(filename[0])
            settings = settings.loc[:, ~settings.columns.str.contains("^Unnamed")]
            for filename, factor, row in zip(
                settings.loc[:, "Filename"],
                settings.loc[:, "Factors"],
                range(len(settings.loc[:, "Filename"])),
            ):
                if (
                    self.Factorizer_Table.item(row, 0) == None
                    and row == self.Factorizer_Table.rowCount() - 1
                ...
                if self.Factorizer_Table.item(row, 0) == None:
                    ...
                    self.Factorizer_Table.setItem(
                        row,
                        2,
                        QTableWidgetItem(filename.split(".")[0] + "_Factorized.csv"),
                    )
        except IndexError as err:
            err = traceback.format_exc()
            ErrorBox("No File Selected", "Please select a file", err)
    ...
    def MassCSV_Browse_Clicked(self):
        try:
            ...
            for row in range(self.MassCSV_Table.rowCount()):
                if (
                    self.MassCSV_Table.item(row, 0) == None
                    and row == self.MassCSV_Table.rowCount() - 1
                ):
                ...
                if self.MassCSV_Table.item(row, 0) == None:
                    ...
                    self.MassCSV_Table.setItem(
                        row,
                        2,
                        QTableWidgetItem(filename[0].split(".")[0] + "_Formatted.csv"),
                    )
                    break
        except IndexError as err:
            err = traceback.format_exc()
    ...
    def MassCSV_Import_Clicked(self):
        try:
            ...
            settings = pd.read_csv(filename[0])
            settings = settings.loc[:, ~settings.columns.str.contains("^Unnamed")]
            for filename, calpuff, row in zip(
                settings.loc[:, "Filename"],
                settings.loc[:, "XY Included"],
                range(len(settings.loc[:, "Filename"])),
            ):
                if (
                    self.MassCSV_Table.item(row, 0) == None
                ...
                if self.MassCSV_Table.item(row, 0) == None:
                    ...
                    self.MassCSV_Table.setItem(
                        row,
                        2,
                        QTableWidgetItem(filename.split(".")[0] + "_Formatted.csv"),
                    )
        except IndexError as err:
            err = traceback.format_exc()
            ErrorBox("No File Selected", "Please select a file", err)
    ...
    def MassCSV_Run_Clicked(self):
        for row in self.Get_Table(self.MassCSV_Table):
            try:
                ...
                ErrorBox(
                    "File Not Found",
                    "File not found, please specify file to format",
                    error,
                )
            except Exception as err:
                err = traceback.format_exc()
        ...
        InfoBox(
            "Complete",
            "Please find files located in their corresponding output location (output file name column)",
        )
    ...
    def NO2_Convert_To_CSV_Clicked(self):
        try:
            csvformatter(
                self.NO2_File_To_Format.text(),
                self.NO2_Calpuff_Format.isChecked(),
                self.NO2_Output_Format.text(),
            )
            InfoBox(
                "Complete",
                "Please find output file located: " + self.NO2_Output_Format.text(),
            )
        except Exception as err:
            err = traceback.format_exc()
            ErrorBox("Error", "An error has occured", err)
    def NO2_Process_CSV_Browse_Clicked(self):
        try:
            ...
            self.NO2_Output_Statistics.setText(
                filename[0].split(".")[0] + "_Statistics.csv"
            )
        except IndexError as err:
            err = traceback.format_exc()
            ErrorBox("No File Selected", "Please select a file", err)
    ...
    def NO2_Run_Stats_Clicked(self):
        try:
            process(
                int(self.NO2_Header_Columns.text()),
                float(self.NO2_Initial_Percent.text()),
                int(self.NO2_Exceedances.text()),
                self.NO2_Background_File.text(),
                self.NO2_Process_CSV.text(),
                self.NO2_Output_Statistics.text(),
            )
        except Exception as err:
            err = traceback.format_exc()
            ErrorBox("Error", "An error has occured", err)
